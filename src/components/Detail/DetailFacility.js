  ...
  return (
    <StyledDetailBox id="Detail-3">
      ...
      <DetailFacilityBox style={{marginBottom:'2%'}} >
        ...
        <DetailFaciltytext style={{paddingLeft:"0",borderRight:'1px solid #e1e1e1',color:'#706ee9'}}>{detailInfo.singleRoom}개</DetailFaciltytext>
        <DetailFaciltytext >2인실</DetailFaciltytext>
        <DetailFaciltytext style={{paddingLeft:"0",borderRight:'1px solid #e1e1e1',color:'#706ee9'}}>{detailInfo.doubleRoom}개</DetailFaciltytext>
        <DetailFaciltytext>3인실</DetailFaciltytext>
        <DetailFaciltytext style={{paddingLeft:"0",borderRight:'1px solid #e1e1e1',color:'#706ee9'}}>{detailInfo.tripleRoom}개</DetailFaciltytext>
        <DetailFaciltytext>4인실</DetailFaciltytext>
        <DetailFaciltytext style={{paddingLeft:"0",color:'#706ee9'}}>{detailInfo.quadrupleRoom}개</DetailFaciltytext>
      </DetailFacilityBox>
      ...
      <DetailFacilityImg style={{marginLeft:'10%'}} src="https://react.semantic-ui.com/images/wireframe/image.png"/>
        ...
        <DetailFaciltytext style={{paddingLeft:"0",paddingRight:'9%',color:'#706ee9',float:'right'}}>{detailInfo.programRoom}개</DetailFaciltytext>
      </DetailFacilityBox>
      ...
      <DetailFacilityImg src="https://react.semantic-ui.com/images/wireframe/image.png"/>
        ...
        <DetailFaciltytext style={{paddingLeft:"0",paddingRight:'9%',color:'#706ee9',float:'right'}}>{detailInfo.trainingRoom}개</DetailFaciltytext>
      </DetailFacilityBox>
    </StyledDetailBox>
  )
}
