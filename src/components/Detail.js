    ...
    <StyledDetailBox id="Detail-5">
      <div>
        ...
        <Icon
          ...
          color="yellow"
        />
        <DetailReviewText style={{ paddingLeft: "3%", paddingRight: "2%" }}>
          {avgStar()}
        </DetailReviewText>
        <DetailReviewText
          style={{ paddingLeft: "2%", borderLeft: "1px solid #444444" }}
        >
          리뷰 {response.reviews.length}개
        </DetailReviewText>
        <DetailReviewButton>
          <img
      ...
      <DetailReviewBox>
        {response.reviews.map((i) => (
          <DetailReviewElement>
            ...
            <DetailReviewText style={{ paddingRight: "2%", color: "black" }}>
              {i.member_id}
            </DetailReviewText>
            <DetailReviewText
              style={{
