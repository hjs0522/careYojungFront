...
exports.wordsState = exports.orderState = exports.gradeState = exports.serviceState = exports.keywordState = exports.loginState = void 0;
...
var wordsState = (0, _recoil.atom)({
  key: "wordsState",
  "default": _searchOptions.keywordOptions[0].key,
  effects_UNSTABLE: [persistAtom]
});
exports.wordsState = wordsState;