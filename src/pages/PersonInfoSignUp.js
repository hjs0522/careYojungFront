...
function PersonInfoSignUp() {
  ...
  return (
    <StyledPersonInfo>
      <Tos tosOpen={tosOpen} setTosOpen={setTosOpen} />
      <StyledBody>
        <StyledText
          style={{
            display: "block",
        ...
        <StyledBox style={{ marginLeft: "5%" }}>
          ...
          <StyledButton onClick={onClickGender} id="M" width="30%" left="0">
            남자
          </StyledButton>
          <StyledButton onClick={onClickGender} id="F" width="30%" left="5%">
            여자
          </StyledButton>
          <StyledButton onClick={onClickGender} id="N" width="30%" left="5%">
            상관없음
          </StyledButton>
        </StyledBox>
        <StyledBox>
        ...
        <StyledBox style={{ width: "100%" }}>
          ...
          <div style={{ marginBottom: "2%" }}>
            <StyledButton id="de" onClick={onClickDisease} left="0">
              치매
            </StyledButton>
            <StyledButton id="ki" onClick={onClickDisease}>
              신부전 (신장질환)
            </StyledButton>
            <StyledButton id="st" onClick={onClickDisease}>
              뇌혈관질환 (중풍 등)
            </StyledButton>
            <StyledButton id="mo" onClick={onClickDisease}>
              운동장애 (파키슨 등)
            </StyledButton>
          </div>
          <div>
            <StyledButton id="he" onClick={onClickDisease} left="0">
              심장질환
            </StyledButton>
            <StyledButton id="ca" onClick={onClickDisease}>
              암
            </StyledButton>
            <StyledButton id="null" onClick={onClickDisease}>
              해당없음
            </StyledButton>
          </div>
        </StyledBox>
        <StyledBox style={{ width: "100%" }}>
          ...
          <div style={{ marginBottom: "2%" }}>
            <StyledButton id="re-mo" onClick={onClickRecover} left="0">
              재활치표, 물리치료
            </StyledButton>
            <StyledButton id="re-de" onClick={onClickRecover}>
              치매치료
            </StyledButton>
            <StyledButton id="re-bl" onClick={onClickRecover}>
              혈액투석
            </StyledButton>
            <StyledButton id="re-al" onClick={onClickRecover}>
              알콜중독치료
            </StyledButton>
          </div>
          <div>
            <StyledButton id="re-null" onClick={onClickRecover} left="0">
              해당없음
            </StyledButton>
          </div>
        </StyledBox>
